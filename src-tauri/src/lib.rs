...
use commands::{
    ...
    native_surface_scroll, native_surface_set_bounds, native_surface_set_cell_metrics,
    native_surface_set_font, native_surface_set_theme, native_surface_set_visible,
